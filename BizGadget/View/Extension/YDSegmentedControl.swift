...
@IBDesignable class YDSegmentedControl: UIControl {
    ...
    @IBInspectable
    var thumbColor : UIColor = UIColor(red: 0.961, green: 0.831, blue: 0.243, alpha: 1.00) {
        didSet {
            setSelectedColors()
        }
    }
    ...
    @IBInspectable
    var borderColor : UIColor = UIColor(red: 0.788, green: 0.788, blue: 0.788, alpha: 1.00) {
        didSet {
    ...
    @IBInspectable
    var thumUnderLineSize:CGFloat = 10 {
        didSet {
            self.layoutSubviews()
        }
    }
    ...
    func setupLabels(){
        ...
        for index in 1...items.count {
            ...
            let label = UILabel(frame:CGRect(x: 0, y: 5, width: 80, height: 40))
